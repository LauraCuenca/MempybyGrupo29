...
def build():
    ...
    [sg.Text("Mempy-By grupo29." ,size=(size))],
    [sg.Text("Este juego, se realizo entre 3 compañeros que realizan el Seminario de Lenguaje de Python, nuestros nombres son: Diego, Laura y Mauro."
